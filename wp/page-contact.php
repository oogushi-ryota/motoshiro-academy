            ...
            <details class="p-contact-faq__details">
              ...
              <ul class="p-contact-faq__list">
                ...
                <li class="p-contact-faq__item">
                  ...
                  <p class="p-contact-faq__answer">
                    以下の通りです。<br>
                    ・授業日の前日23:59までに、Comiru上でご連絡をいただいた場合 → 振替授業が可能です。<br>
                    ・授業当日（前日24:00以降）のご連絡、または無断欠席の場合 → 授業は実施扱いとなり、振替・返金はできません。<br>
                ...
                <li class="p-contact-faq__item">
                  ...
                  <p class="p-contact-faq__answer">
                    原則として、できる限り同じ講師が継続して担当いたします。<br>
                    ただし、講師のスケジュールの都合や振替授業の調整状況によっては、別の講師が担当させていただく場合がございます。<br>
                    その際も、学習内容や進度を共有したうえで対応いたしますので、ご安心ください。
                  </p>
                </li>
              </ul>
            </details>
